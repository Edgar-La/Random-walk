...
def plotter(X, Bounds, dcm):
	...
	ax1.set_title('Random Walker')
	ax1.set(xlabel='Time (t)', ylabel='Position (x)')			#Agrega titulo y nombre de etiquetas al grafico 1

	ax2 = fig.add_subplot(1,2,2)
	ax2.plot(dcm)
	ax2.set_title('DCM')
	ax2.set(xlabel='', ylabel='')											#Agrega titulo y nombre de etiquetas al grafico 2
	plt.show()
